var e=Object.defineProperty,t=(t,n)=>{let r={};for(var i in t)e(r,i,{get:t[i],enumerable:!0});return n||e(r,Symbol.toStringTag,{value:`Module`}),r};(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var n=`modulepreload`,r=function(e){return`/keyboard-learn/`+e},i={},a=function(e,t,a){let o=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),s=document.querySelector(`meta[property=csp-nonce]`),c=s?.nonce||s?.getAttribute(`nonce`);function l(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function u(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}o=l(t.map(t=>{if(t=r(t,a),t=u(t),t in i)return;i[t]=!0;let o=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let r=e[n];if(r.href===t&&(!o||r.rel===`stylesheet`))return}let s=document.createElement(`link`);if(s.rel=o?`stylesheet`:n,o||(s.as=`script`),s.crossOrigin=``,s.href=t,c&&s.setAttribute(`nonce`,c),document.head.appendChild(s),o)return new Promise((e,n)=>{s.addEventListener(`load`,e),s.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function s(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return o.then(t=>{for(let e of t||[])e.status===`rejected`&&s(e.reason);return e().catch(s)})};function o(e){let t=document.getElementById(`app`);t&&(t.innerHTML=`
  ...
  `,e.appendChild(n),setTimeout(()=>n.remove(),2e3)}function j(e,t,n,r){let i=de(t.score,t.totalQuestions),a=[,,,,,].fill(0).map((e,t)=>t<i?`⭐`:`☆`).join(``),o=v(t.elapsedMs),s=t.mode===`word`?`单词`:`字母`,c=(t.mode,t.totalQuestions),l=v(c>0?Math.round(t.elapsedMs/c):0);e.innerHTML=`
  ...
  `,e.querySelector(`#btn-restart`)?.addEventListener(`click`,n),e.querySelector(`#btn-back`)?.addEventListener(`click`,r)}function de(e,t){let n=e/(t*10);return n>=.95?5:n>=.8?4:n>=.6?3:n>=.4?2:1}var M=`menu`,N=null,P=null,F=null,I=null;function fe(){o(L)}function L(e){switch(e){case`familiar`:R(`familiar`,`键盘熟习练习`);break;case`alphabet`:R(`alphabet`,`按字母顺序练习`);break;case`number`:R(`number`,`数字键练习`);break;case`full`:R(`full`,`全键盘练习`);break;case`word`:B();break}}function R(e,t){M=e;let n=document.getElementById(`app`);n.innerHTML=pe(t,e);let r=document.getElementById(`keyboard-canvas`),i=document.getElementById(`finger-canvas`);N=new m({canvas:r}),P=new h({canvas:i}),F=new ce({onQuestion:e=>z(e),onCorrect:e=>me(e),onWrong:(e,t)=>he(e,t),onStreak:e=>H(e),onFinish:t=>ge(t,e),onScoreChange:e=>U(e),onTimerUpdate:e=>W(e),onPauseChange:e=>G(e)},e),n.querySelector(`#btn-back`)?.addEventListener(`click`,()=>{F?.stop(),$(),o(L)}),n.querySelector(`#btn-pause`)?.addEventListener(`click`,()=>{F?.togglePause()}),F.start(),J(),K()}function pe(e,t){return`
  ...
  `}function z(e){let t=document.getElementById(`question-hint`),n=document.getElementById(`question-key`),r=document.getElementById(`question-finger`),i=document.getElementById(`progress-display`);if(t&&(t.textContent=e.hint),n&&(n.textContent=e.key.toUpperCase(),n.style.color=e.fingerColor),r&&(r.textContent=e.fingerName,r.style.color=e.fingerColor),i&&F){let e=F.getState();i.textContent=`${e.currentIndex}/${e.totalQuestions}`}N?.highlight(e.key,e.finger),P?.activateFinger(e.finger)}function me(e){let t=document.getElementById(`feedback-container`);t&&k(t),N?.showPress(e.key)}function he(e,t){let n=document.getElementById(`feedback-container`);n&&A(n,`按了 "${t.toUpperCase()}"，请用${e.fingerName}按 "${e.key.toUpperCase()}"`)}function ge(e,t){let n=F?.getState();n&&O(t,n.score,n.correctCount,n.wrongCount,n.maxStreak),j(document.getElementById(`app`),{...e,mode:t},()=>{R(t,{familiar:`键盘熟习练习`,alphabet:`按字母顺序练习`,number:`数字键练习`,full:`全键盘练习`}[t]||``)},()=>{$(),o(L)})}function B(){M=`word`;let e=document.getElementById(`app`);e.innerHTML=_e();let t=document.getElementById(`keyboard-canvas`),n=document.getElementById(`finger-canvas`);N=new m({canvas:t}),P=new h({canvas:n}),I=new C({onWordStart:e=>ve(e),onCharCorrect:(e,t)=>ye(e,t),onCharWrong:(e,t,n)=>be(e,t,n),onWordComplete:(e,t)=>xe(e,t),onStreak:e=>H(e),onFinish:e=>Se(e),onScoreChange:e=>U(e),onTimerUpdate:e=>W(e),onPauseChange:e=>G(e)}),e.querySelector(`#btn-back`)?.addEventListener(`click`,()=>{I?.stop(),$(),o(L)}),e.querySelector(`#btn-pause`)?.addEventListener(`click`,()=>{I?.togglePause()}),I.start(),J(),K()}function _e(){return`
    <div class="practice-container">
      <div class="pause-overlay" id="pause-overlay" style="display:none;">
        <div class="pause-icon">⏸️</div>
        <div class="pause-text">已暂停</div>
  ...
  `}function ve(e){let t=document.getElementById(`word-letters`),n=document.getElementById(`progress-display`);if(t&&(t.innerHTML=e.word.split(``).map((e,t)=>`<span class="word-letter" data-index="${t}" id="letter-${t}">${e.toUpperCase()}</span>`).join(``)),n&&I){let e=I.getState();n.textContent=`${e.currentIndex}/${e.totalQuestions}`}V(0)}function V(e){document.querySelectorAll(`.word-letter`).forEach(e=>{e.classList.remove(`active`,`correct`,`wrong`)});let t=document.getElementById(`letter-${e}`);t&&t.classList.add(`active`);let n=I?.getCurrentWord();if(n&&n.questions[e]){let t=n.questions[e];N?.highlight(t.key,t.finger),P?.activateFinger(t.finger)}}function ye(e,t){let n=document.getElementById(`letter-${e}`);n&&(n.classList.remove(`active`),n.classList.add(`correct`));let r=document.getElementById(`feedback-container`);r&&k(r),N?.showPress(t.key),setTimeout(()=>V(e+1),200)}function be(e,t,n){let r=document.getElementById(`letter-${e}`);r&&(r.classList.add(`wrong`),setTimeout(()=>r.classList.remove(`wrong`),300));let i=document.getElementById(`feedback-container`);i&&A(i,`按了 "${n.toUpperCase()}"`)}function xe(e,t){let n=document.getElementById(`feedback-container`);if(n){let t=document.createElement(`div`);t.className=`feedback-word-complete`,t.innerHTML=`🎉 太棒了！"${e.toUpperCase()}" 输入完成！`,n.appendChild(t),setTimeout(()=>t.remove(),1e3)}}function Se(e){let t=I?.getState();t&&O(`word`,t.score,t.correctCount,t.wrongCount,t.maxStreak),j(document.getElementById(`app`),{...e,mode:`word`},()=>B(),()=>{$(),o(L)})}function H(e){let t=document.getElementById(`feedback-container`);t&&ue(t,e);let n=document.getElementById(`streak-display`);n&&(n.classList.add(`streak-pop`),setTimeout(()=>n.classList.remove(`streak-pop`),500))}function U(e){let t=document.getElementById(`score-display`);t&&(t.textContent=String(e));let n=document.getElementById(`streak-display`);if(n){let e=F?.getState()||I?.getState();n&&e&&(n.textContent=String(e.streak))}}function W(e){let t=document.getElementById(`timer-display`);t&&(t.textContent=e)}function G(e){let t=document.getElementById(`pause-overlay`),n=document.getElementById(`btn-pause`);t&&(t.style.display=e?`flex`:`none`),n&&(n.textContent=e?`▶️`:`⏯️`)}function K(){document.addEventListener(`keydown`,q)}function q(e){if(e.key!==` `&&e.code!==`Space`)return;let t=F||I;if(!(!t||t.getState().isFinished)){if(F){let e=F.getCurrentQuestion();if(e&&(e.key===` `||e.key===`Space`))return}e.preventDefault(),t.togglePause()}}function J(){document.removeEventListener(`keydown`,Q),document.removeEventListener(`keyup`,Z),document.removeEventListener(`contextmenu`,X),setTimeout(()=>{document.addEventListener(`keydown`,Q),document.addEventListener(`keyup`,Z),document.addEventListener(`contextmenu`,X)},100)}function Y(){return M===`full`&&F!==null&&!F.getState().isFinished&&!F.getState().isPaused}function X(e){Y()&&e.preventDefault()}function Z(e){Y()&&e.preventDefault()}function Q(e){if(Y()){if(e.preventDefault(),e.key===` `||e.code===`Space`){let e=F.getCurrentQuestion();e&&(e.key===` `||e.key===`Space`)&&F.handleKeyPress(`Space`);return}F.handleKeyPress(e.key,e.code);return}if(e.key===` `||e.code===`Space`){if(F&&!F.getState().isFinished&&!F.getState().isPaused){let t=F.getCurrentQuestion();if(t&&(t.key===` `||t.key===`Space`)){e.preventDefault(),F.handleKeyPress(`Space`);return}}return}if(M===`word`&&I){let t=document.activeElement;(!t||t===document.body||t.tagName===`BUTTON`)&&(e.preventDefault(),I.handleKeyPress(e.key))}else F&&(e.preventDefault(),F.handleKeyPress(e.key))}function $(){document.removeEventListener(`keydown`,Q),document.removeEventListener(`keyup`,Z),document.removeEventListener(`contextmenu`,X),document.removeEventListener(`keydown`,q)}fe();